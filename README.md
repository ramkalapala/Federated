...
# 3. Exact Libraries Required by the Notebook <br/>
  ...
  jupyter==1.0.0 <br/>
  notebook==7.0.6 <br/>
# 4. requirements.txt Content <br/>
    Create a file named requirements.txt in the same GitHub project folder and place the following content exactly as shown below. <br/>
  numpy==1.24.4 <br/>
  pandas==2.0.3 <br/>
  scikit-learn==1.3.0 <br/>
  matplotlib==3.7.2 <br/>
  jupyter==1.0.0 <br/>
  notebook==7.0.6 <br/>
# 5. Expected Folder Structure <br/>
  The notebook contains the line pd.read_csv('./DATA/Medical_insurance.csv'). Therefore, the dataset must be placed inside a folder named DATA at the root of the repository. The structure below is the correct GitHub-ready layout. <br/>
